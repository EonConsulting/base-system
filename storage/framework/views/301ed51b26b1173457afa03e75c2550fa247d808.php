...
<div class="row">
    ...
    <h3><?php echo e($response->title); ?> <small><span class="text-muted">Faculty: </span> <?php echo e($faculty); ?></small></h3>
    <div class="meta">
        <small><span class="text-muted">Field: </span> <?php echo e($response->field); ?></small> |
        <small><span class="text-muted">Term: </span> <?php echo e($response->term); ?></small>
        <br />
        <br />
    </div>
    <p><?php echo e($response->description); ?></p>
    <hr />
    <small><?php echo e($response->notes); ?></small>
</div>