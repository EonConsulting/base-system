    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <div class="col-md-12">
                    <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $element): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>

                        <?php if(!strpos($key, '.')): ?>
                            <?php if($key != $previous_key): ?>
                                <?php
                                    $label = $element['name'];
