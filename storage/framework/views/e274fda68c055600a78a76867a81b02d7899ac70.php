                    ...
                    <form id="meta-form" class="form-horizontal" method="POST">
                        ...
                        <div class="form-group">
                            <select class="select2 form-control" name="classification" id="classification">
                                <?php $__currentLoopData = $classifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
