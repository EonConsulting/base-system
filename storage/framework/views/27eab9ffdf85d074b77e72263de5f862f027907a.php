...
<head>
    ...
    <?php for($i = 0 ;$i < count($styles); $i++): ?>
        <link type="text/css" rel="stylesheet" href="<?php echo e($styles[$i]); ?>"/>
    <?php endfor; ?>
...
<div class="navbar-fixed">
    <nav class="grey">
        <div class="nav-wrapper container subtopic">
            ...
            <a href="<?php echo e(route('lti.index')); ?>"><i class="fa fa-home fa-lg"></i></a>
            <ul class="left hide-on-med-and-down">
                <li><a class="dropdown-button" href="#!" data-activates="dropdown1"><i class="fa fa-bars"></i></a><?php echo $menu; ?></li>
            </ul>
...
<?php if($previous['link'] != $previous['current']): ?>
    <a href="<?php echo e($previous['href']); ?>" title="<?php echo e($previous['title']); ?>">
        <div class="triangle previous-arrow"></div>
    </a>
<?php endif; ?>

<?php if(gettype($next['link']) != "NULL"): ?>
    <a href="<?php echo e($next['href']); ?>" title="<?php echo e($next['title']); ?>">
        <div class="triangle next-arrow"></div>
    </a>
<?php endif; ?>
...
<div class="container">
    <div class="row">
        <div class="col s12">
            <h1 class="topic-list-header"><?php echo e($story['title']); ?></h1>
            <br />
            <p><?php echo strip_tags($story['summary']); ?></p>
            <br /><br />
            <?php echo $breadcrumb; ?>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <iframe src="<?php echo e($page); ?>" class="composite-embed" id="idIframe" frameBorder="0" style="display: block;"></iframe>
        </div>
    </div>
</div>
...
<?php for($i = 0 ; $i < count($scripts); $i++): ?>
    <script src="<?php echo e($scripts[$i]); ?>"></script>
<?php endfor; ?>
